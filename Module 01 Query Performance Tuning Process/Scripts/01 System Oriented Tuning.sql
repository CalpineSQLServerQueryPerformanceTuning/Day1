...
-- System Tables
-- List Databases on Instance with DB_ID
select * from sys.databases; 


-- List Files for Current Database
...
-- Dynamic Management Views (DMVs) and Dynamic Managment Functions (DMFs) 
-- are collectively called Dynamic Management Objects (DMOs)
