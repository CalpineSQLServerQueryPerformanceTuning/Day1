...
--				Verify this by looking at both data access operator's 
--				ordered properties
--				Also note both operators only executed once each
...
from 
						HumanResources.Employee		as e
	left outer join		Sales.SalesPerson			as sp		on e.BusinessEntityID = sp.BusinessEntityID
;
